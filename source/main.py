...
async def on_message(message): #All the messages the bot sends
    if message.content.startswith(';;r1'):
        ...
        print(message.author, "used the ;;r1 command in the", message.channel, "channel")
    ...
    if message.content.startswith(';;r4'):
        ...
        print(message.author, "used the ;;r4 command in the", message.channel, "channel")
    if message.content.startswith(';;r5'):
        ...
        print(message.author, "used the ;;r5 command in the", message.channel, "channel")
    ...
    if message.content.startswith(';;r8'):
        ...
        print(message.author, "used the ;;r8 command in the", message.channel, "channel")
